...
| 2019     | **TransW**     |                                **Composing Knowledge Graph Embeddings via Word Embeddings**                                 |   arXiv   | Transductive |                             [link](https://arxiv.org/pdf/1909.03794.pdf)                              |                                                                -                                                                 |
...
### Attribute Enhanced Models <span id="AM"></span>
#### Extra-Weight Enhanced Models <span id="EWEM"></span>
| **Year** |     **Model**    |                                                                     **Title**                                                                    | **Venue** |  **Scenario** |                                 **Paper**                                |                                **Code**                                 |
|:--------:|:----------------:|:------------------------------------------------------------------------------------------------------------------------------------------------:|:---------:|:-------------:|:------------------------------------------------------------------------:|:-----------------------------------------------------------------------:|
...
#### Extra-Embedding Enhanced Models <span id="EEEM"></span>
| **Year** |         **Model**         |                                                **Title**                                               | **Venue** |  **Scenario** |                                          **Paper**                                         |                                **Code**                               |
|:--------:|:-------------------------:|:------------------------------------------------------------------------------------------------------:|:---------:|:-------------:|:------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------:|
...
| **Year** |     **Model**     |                                                              **Title**                                                             | **Venue** | **Scenario** |                                                    **Paper**                                                     |                         **Code**                         |
|:--------:|:-----------------:|:----------------------------------------------------------------------------------------------------------------------------------:|:---------:|:------------:|:----------------------------------------------------------------------------------------------------------------:|:--------------------------------------------------------:|
| 2021     | **Krisp**         | **Krisp: Integrating implicit and symbolic knowledge for open domain knowledge-based vq**                                          | CVPR      | Transductive |                                   [Link](https://arxiv.org/pdf/2012.11014.pdf)                                   | -                                                        |
...
| 2018     | **MNED**          | **Multimodal Named Entity Disambiguation for Noisy Social Media Posts**                                                            | ACL       | Transductive |                                  [Link](https://aclanthology.org/P18-1186.pdf)                                   | -                                                        |
| 2018     | **-**             | **a multimodal translation-based approach for knowledge graph representation learning**                                            | ICML      | Transductive |                                  [Link](https://aclanthology.org/S18-2027.pdf)                                   | [Link](https://github.com/UKPLab/starsem18-multimodalKB) |
...
| 2017     | **Visual Genome** | **Visual Genome: Connecting Language and Vision Using Crowdsourced Dense Image Annotations**                                       | IJCV      | Transductive |                                   [Link](https://arxiv.org/pdf/1602.07332.pdf)                                   | -                                                        |
...
| 2017     | **HC**            | **Towards Holistic Concept Representations: Embedding Relational Knowledge, Visual Attributes, and Distributional Word Semantics** | ISWC      | Transductive |                         [Link](https://dl.acm.org/doi/abs/10.1007/978-3-319-68288-4_41)                          | -                                                        |
