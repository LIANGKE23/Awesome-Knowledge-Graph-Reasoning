...
#### GNN Models <span id="graph-neural-network-models-"></span>
 |**Year** | **Model**     | **Title**                                                                                                       | **Venue**    | **Scenario**    | **Paper**                                                                                                                                                          | **Code**                                                              |
|----------|---------------|-----------------------------------------------------------------------------------------------------------------|--------------|-----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|
| 2023     | **REPORT**      | **InGram: Inductive Knowledge Graph Embedding via Relation Graphs**                                   | ICML        | Inductive       | [Link](https://arxiv.org/abs/2305.19987)                                                                                                                       | [Link](https://github.com/bdi-lab/InGram)                                 |
