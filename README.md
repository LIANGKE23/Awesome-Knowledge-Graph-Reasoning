...
|:--------:|:--------------:|:---------------------------------------------------------------------------------------------------------------------------:|:---------:|:------------:|:-----------------------------------------------------------------------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------:|
| 2024     | **ReED**     |                  **PAC-Bayesian Generalization Bounds for Knowledge Graph Representation Learning**                   |   ICML    | Inductive |                      [Link](https://proceedings.mlr.press/v235/lee24i.html)                    |                         [Link](https://github.com/bdi-lab/ReED)   |
| 2024     | **RecPiece**     |                  **Clustering then Propagation: Select Better Anchors for Knowledge Graph Embedding**                   |   NeurIPS    | Inductive |                      [Link](https://nips.cc/virtual/2024/poster/96176)                    |                         [Link](-)   |
...
| **Year** |  **Model**  |                                            **Title**                                            | **Venue** | **Scenario** |                                               **Paper**                                               |                        **Code**                         |
|:--------:|:------------:|:-----------------------------------------------------------------------------------------------:|:---------:|:------------:|:-----------------------------------------------------------------------------------------------------:|:-------------------------------------------------------:|
| 2024     | **IVR**      | **Knowledge Graph Completion by Intermediate Variables Regularization**                                   |  NeurIPS   | Inductive       | [Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/c700d47679e325215a3edb323b63f069-Paper-Conference.pdf)                                                                                                                       | [Link](https://github.com/changyi7231/IVR)                                  |
...
#### GNN Models <span id="graph-neural-network-models-"></span>
 |**Year** | **Model**     | **Title**                                                                                                       | **Venue**    | **Scenario**    | **Paper**                                                                                                                                                          | **Code**                                                              |
|----------|---------------|-----------------------------------------------------------------------------------------------------------------|--------------|-----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|
|   2025   |   **FS-KEN**    | **FS-KEN: Few-shot Knowledge Graph Reasoning by Adversarial Negative Enhancing**      |       IJCAI       | Inductive | [Link](-) |                    [Link](-)                      |
...
|**Year** | **Model**     | **Title**                                                                                                       | **Venue**    | **Scenario**    | **Paper**                                                                                                                                                          | **Code**                                                              |
|----------|---------------|-----------------------------------------------------------------------------------------------------------------|--------------|-----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|
| 2025 |  **SRP-KGC**  |        **Soft Reasoning Paths for Knowledge Graph Completion**        |           IJCAI        | Inductive       |                  [Link]()                    | [Link]() |
| 2024 |  **MindMap**  |        **MindMap: Knowledge Graph Prompting Sparks Graph of Thoughts in Large Language Models**        |           ACL        | Inductive       |                  [Link](https://aclanthology.org/2024.acl-long.558.pdf)                    | [Link](https://github.com/wyl-willing/MindMap) |
| 2024     | **KG-ICL**      | **A Prompt-Based Knowledge Graph Foundation Model for Universal In-Context Reasoning**                                   |  NeurIPS   | Inductive       | [Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/0d70af566e69f1dfb687791ecf955e28-Paper-Conference.pdf)                                                                                                                       | [Link](https://github.com/nju-websoft/KG-ICL)                                  |
| 2024     | **KnowledgeCircuits**      | **Knowledge Circuits in Pretrained Transformers**                                   |  NeurIPS   | Inductive       | [Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/d6df31b1be98e04be48af8bedb95b499-Paper-Conference.pdf)                                                                                                                       | [Link](https://github.com/zjunlp/KnowledgeCircuits)                                  |
| 2024     | **MKG**      | **Construction and Application of Materials Knowledge Graph in Multidisciplinary Materials Science via Large Language Model**                                   |  NeurIPS   | Inductive       | [Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/680da2fd0331deecc2e5b7cf0e55e832-Paper-Conference.pdf)                                                                                                                       | [Link](https://github.com/MasterAI-EAM/Material-Knowledge-Graph)                                  |
| 2024     | **KnowGPT**      | **KnowGPT: Knowledge Graph based Prompting for Large Language Models**                                   |  NeurIPS   | Inductive       | [Link](https://proceedings.neurips.cc/paper_files/paper/2024/hash/0b8705a611ed1ce19cdb759031078705-Abstract-Conference.html)                                                                                                                       | [Link]()                                  |
| 2024     | **PGraphVis**      | **PGraphVis: Boosting LLMs with Visual Knowledge Graph Integration**                                   |  NeurIPS   | Inductive       | [Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/7cb04f510593c9ba30da398f5e0a7e7b-Paper-Conference.pdf)                                                                                                                       | [Link](https://github.com/yihedeng9/GraphVis)                                  |
| 2024     | **PoG**      | **Plan-on-Graph: Self-Correcting Adaptive Planning of Large Language Model on Knowledge Graphs**                                   |  NeurIPS   | Inductive       | [Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/f606d45ae7b991988b6eea2af38b7057-Paper-Conference.pdf)                                                                                                                       | [Link](https://github.com/liyichen-cly/PoG)                                  |
| 2024     | **KG-FIT**      | **KG-FIT: Knowledge Graph Fine-Tuning Upon Open-World Knowledge**                                   |  NeurIPS   | Inductive       | [Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/f606d45ae7b991988b6eea2af38b7057-Paper-Conference.pdf)                                                                                                                       | [Link](https://github.com/pat-jj/KG-FIT)                                  |
| 2024     | **GRT**      | **Graph Reasoning Transformers for Knowledge-Aware Question Answering**                                   |  AAAI   | Inductive       | [Link](https://ojs.aaai.org/index.php/AAAI/article/view/29938/31639)                                                                                                                       | [Link](https://github.com/HUSTNLP-codes/GRT)                                  |
| 2024     | **KG-LLM-MDQA**      | **Knowledge Graph Prompting for Multi-Document Question Answering**                                   |  AAAI   | Inductive       | [Link](https://ojs.aaai.org/index.php/AAAI/article/view/29889/31552)                                                                                                                       | [Link](https://github.com/YuWVandy/KG-LLM-MDQA)                                  |
| 2024     | **KGR**      | **Mitigating Large Language Model Hallucinations via Autonomous Knowledge Graph-Based Retrofitting**                                   |  AAAI   | Inductive       | [Link](https://ojs.aaai.org/index.php/AAAI/article/view/29770/31326)                                                                                                                       | [Link](-)                                  |
| 2024     | **KGEditor**      | **Editing Language Model-Based Knowledge Graph Embeddings**                                   |  AAAI   | Inductive       | [Link](https://ojs.aaai.org/index.php/AAAI/article/view/28680)                                                                                                                       | [Link](https://github.com/AnonymousForPapers/DeltaKG)                                  |
...
| 2024     | **KnowFormer**      | **KnowFormer: Revisiting Transformers for Knowledge Graph Reasoning**                                   |  ICML   | Inductive       | [Link](https://openreview.net/pdf?id=EncFNR3hxM)                                                                                                                       | -                              |
...
| **Year** | **Model**         | **Title**                                                                                       | **Venue** | **Scenario** | **Paper**                                                                                                                          |                        **Code**                        |
|----------|-------------------|-------------------------------------------------------------------------------------------------|-----------|--------------|------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------:|
| 2024     | **RLF-KG**           | **Advancing Abductive Reasoning in Knowledge Graphs through Complex Logical Hypothesis Generation** | ACL                    | Transductive |  [Link](https://aclanthology.org/2024.acl-long.72.pdf) |                    [Link](https://github.com/HKUST-KnowComp/AbductiveKGR)                   |
| 2024     | **BIKG**           | **Bayesian Inference with Complex Knowledge Graph Evidence** | AAAI                    | Transductive |  [Link](https://ojs.aaai.org/index.php/AAAI/article/view/30040/31830) |                    [Link](https://github.com/atoroghi/BIKG)                   |
...
|:--------:|:----------------:|:--------------------------------------------------------------------------------------------------------------------------------:|:----------------------:|:-------------:|:-------------:|
| 2024 | **Confidence is not Timeless: Modeling Temporal Validity for Rule-based Temporal Knowledge Graph Forecasting** |  ACL | Extrapolation | [Link](https://aclanthology.org/2024.acl-long.580.pdf) | [Link](-) |
| 2024 | **TEILP: Time Prediction over Knowledge Graphs via Logical Reasoning** |  AAAI | Extrapolation | [Link](https://ojs.aaai.org/index.php/AAAI/article/view/29544/30907) | [Link](-) |
...
| **Year** |    **Model**     |                                                            **Title**                                                             |       **Venue**        |  **Scenario** |                                         **Paper**                                          |                                **Code**                                |
|:--------:|:----------------:|:--------------------------------------------------------------------------------------------------------------------------------:|:----------------------:|:-------------:|:------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------:|
| 2024 |     **TPAR**    |                 **A Unified Temporal Knowledge Graph Reasoning Model Towards Interpolation and Extrapolation**                 | ACL   | Interpolation |        [Link](https://aclanthology.org/2024.acl-long.8.pdf)       |      [Link](-)
...
| **Year** |    **Model**     |                                                            **Title**                                                             |       **Venue**        |  **Scenario** |                                         **Paper**                                          |                                **Code**                                |
|:--------:|:----------------:|:--------------------------------------------------------------------------------------------------------------------------------:|:----------------------:|:-------------:|:------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------:|
|   2024   |     **TGB2**      |                               **TGB 2.0: A Benchmark for Learning on Temporal Knowledge Graphs and Heterogeneous Graphs**                                |     NeurIPS     | Extrapolation |    [Link](https://proceedings.neurips.cc/paper_files/paper/2024/file/fda026cf2423a01fcbcf1e1e43ee9a50-Paper-Datasets_and_Benchmarks_Track.pdf)    |               [Link](https://github.com/JuliaGast/TGB2)           |
|   2024   |     **LLM-DA**      |                               **Large Language Models-guided Dynamic Adaptation for Temporal Knowledge Graph Reasoning**                                |     NeurIPS     | Extrapolation |    [Link](https://nips.cc/virtual/2024/poster/96116)    |               [Link](https://github.com/jiapuwang/LLM-DA)           |
...
| **Year** |         **Model**         |                                                                    **Title**                                                                     | **Venue** |  **Scenario** |                           **Paper**                            |                                **Code**                                 |
|:--------:|:-------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------:|:---------:|:-------------:|:--------------------------------------------------------------:|:-----------------------------------------------------------------------:|
| 2024 |     **TCompoundE**     |                 **Simple but Effective Compound Geometric Operations for Temporal Knowledge Graph Completion**                 |    ACL    | Extrapolation |        [Link](https://arxiv.org/pdf/2403.19881)       |                        [Link](https://github.com/nk-ruiying/TCompoundE)                        |
...
| **Year** |     **Model**     |                                                              **Title**                                                             | **Venue** |                                                    **Paper**                                                     |                         **Code**                         |
|:--------:|:-----------------:|:----------------------------------------------------------------------------------------------------------------------------------:|:---------:|:----------------------------------------------------------------------------------------------------------------:|:--------------------------------------------------------:|
| 2024 |  **MR-MKG**  |        **Multimodal Reasoning with Multimodal Knowledge Graph**        |           ACL          |                     [Link](https://aclanthology.org/2024.acl-long.579.pdf)                    | [Link](-) |
| 2024 |  **UKnow**  |        **UKnow: A Unified Knowledge Protocol with Multimodal Knowledge Graph Datasets for Reasoning and Vision-Language Pre-Training**        |           NeurIPS          |                     [Link](https://nips.cc/virtual/2024/poster/97740)                    | [Link](https://nips.cc/virtual/2024/poster/97740) |
| 2024 |  **ImgFact**  |        **Beyond Entities: A Large-Scale Multi-Modal Knowledge Graph with Triplet Fact Grounding**        |           AAAI          |                     [Link](https://ojs.aaai.org/index.php/AAAI/article/view/29828/31438)                    | [Link](https://github.com/kleinercubs/ImgFact) |
| 2024 |  **MKG-FENN**  |        **MKG-FENN: A Multimodal Knowledge Graph Fused End-to-End Neural Network for Accurate Drug–Drug Interaction Prediction**        |           AAAI          |                     [Link](https://ojs.aaai.org/index.php/AAAI/article/view/28887/29686)                    | [Link](https://github.com/wudi1989/MKG-FENN) |
| 2024 |  **Structure-CLIP**  |        **Structure-CLIP: Towards Scene Graph Knowledge to Enhance Multi-Modal Structured Representations**        |           AAAI          |                     [Link](https://ojs.aaai.org/index.php/AAAI/article/view/28017/28048)                    | [Link](https://github.com/zjukg/Structure-CLIP) |
